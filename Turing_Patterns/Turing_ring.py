...
#Here we create a 1D Turing pattern with 2 morphogens:
#There are 2 morphogens diffusing around a 1D ringand reacting (play around with reaction parameters
#a,b,c,d and diffusino coefficents mu,nu);
#Run the script and see concentration profiles of both morphogens (centred around the fixed point).
#See (Turing, 1952) for more details.
#Note to self: update at some point to provide examples of different regimes of Turing pattern formation.
...
plt.ylabel('Concentration (centred)')
line1, = plt.plot([],[],'g-')
line2, = plt.plot([],[],'b-')
...
anim = animation.FuncAnimation(fig, update, 
        frames=N, fargs=(line1, line2), interval=100)
